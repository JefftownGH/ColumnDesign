...
namespace ColumnDesign.Styles
{
    ...
    public partial class SettingsWindowStyle
    {
        ...
        {
            if (e.ClickCount > 1) sender.ForWindowFromTemplate(SystemCommands.CloseWindow);
        }
        ...
        private void WindowLoaded(object sender, RoutedEventArgs e) => ((Window)sender).StateChanged += WindowStateChanged;
        ...
        private void MinButtonClick(object sender, RoutedEventArgs e) => sender.ForWindowFromTemplate(SystemCommands.MinimizeWindow);
