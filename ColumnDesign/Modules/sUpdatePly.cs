...
' # # # # # # # # # # # # # # # # # # # # # # # # # # # #
    ...
    'Input source of 2 is for changes from the window checkboxes or the window position dimensions (INVALID FOR SCISSOR CLAMPS)
